// Espelha Backend/src/reviews/review-tags.constants.ts — mantenha os dois em sync manualmente
// (não há pacote compartilhado entre os projetos). O servidor valida de novo, não confia só nisso.
